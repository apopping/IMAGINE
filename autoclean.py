...
if mosaic: run_command("mossdi map=" + file_map + " beam=" + file_beam + " out=" + file_model + " niters=100000 cutoff=" + str(thresh_hi));
else: run_command("clean map=" + file_map + " beam=" + file_beam + " out=" + file_model + " niters=100000 cutoff=" + str(thresh_hi));
...
if mosaic: run_command("mossdi map=" + file_map + " beam=" + file_beam + " out=" + file_model_2 + " niters=100000 cutoff=" + str(thresh_lo) + " region=\"mask(" + file_sofia_mask_2 + ")\"");
else: run_command("clean map=" + file_map + " beam=" + file_beam + " out=" + file_model_2 + " niters=100000 cutoff=" + str(thresh_lo) + " region=\"mask(" + file_sofia_mask_2 + ")\"");
