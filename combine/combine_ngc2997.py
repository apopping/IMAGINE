...
os.system('python /home/apopping/imagine/pipeline/IMAGINE/process_imagine.py /home/apopping/imagine/new_pars/ngc2997_h214_1.par')
os.system('python /home/apopping/imagine/pipeline/IMAGINE/process_imagine.py /home/apopping/imagine/new_pars/ngc2997_750a_1.par')
os.system('python /home/apopping/imagine/pipeline/IMAGINE/process_imagine.py /home/apopping/imagine/new_pars/ngc2997_750b_1.par')
os.system('python /home/apopping/imagine/pipeline/IMAGINE/process_imagine.py /home/apopping/imagine/new_pars/ngc2997_ew367_1.par')

os.chdir('/mnt/science1/imagine/processed/' + par['target'])

vis='750a/*.uvlin,750b/*.uvlin,ew367/*.uvlin,h214/*.uvlin'
vis='750a/*.uvlin,ew367/*.uvlin,h214/*.uvlin'
